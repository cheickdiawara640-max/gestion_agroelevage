...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold">➕ Enregistrer une Nouvelle Vente</h2>
                ...
                <div class="row g-3 mb-4">
                        ...
                        <select class="form-select" id="recolte_id" name="recolte_id" required>
                            ...
                            @foreach ($recoltes as $recolte)
                                <option value="{{ $recolte->id }}" 
                                    {{ old('recolte_id') == $recolte->id ? 'selected' : '' }}>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="produit_vendu" name="produit_vendu" 
                               value="{{ old('produit_vendu') }}" required>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" class="form-control" id="quantite_vendue" name="quantite_vendue" 
                               value="{{ old('quantite_vendue') }}" oninput="calculerMontant()" required>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" id="unite_quantite" name="unite_quantite" 
                               value="{{ old('unite_quantite') }}" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="prix_unitaire" name="prix_unitaire" 
                               value="{{ old('prix_unitaire') }}" oninput="calculerMontant()" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" class="form-control fw-bold bg-light" id="montant_total" name="montant_total" 
                               value="{{ old('montant_total') }}" readonly required>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        ...
                        <select class="form-select" id="mode_vente" name="mode_vente" required>
                            ...
                            <option value="Vente Directe" {{ old('mode_vente') == 'Vente Directe' ? 'selected' : '' }}>Vente Directe (ferme, marché)</option>
                            <option value="Grossiste" {{ old('mode_vente') == 'Grossiste' ? 'selected' : '' }}>Grossiste / Intermédiaire</option>
                            <option value="Exportation" {{ old('mode_vente') == 'Exportation' ? 'selected' : '' }}>Exportation</option>
                            <option value="Transformation Interne" {{ old('mode_vente') == 'Transformation Interne' ? 'selected' : '' }}>Transformation Interne</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" id="mode_paiement" name="mode_paiement">
                            ...
                            <option value="Crédit" {{ old('mode_paiement') == 'Crédit' ? 'selected' : '' }}>Crédit / Paiement différé</option>
                        </select>
                    </div>
                    
                    <div class="col-md-4">
                        <label for="client_nom" class="form-label">Nom du Client (Optionnel):</label>
                        <input type="text" class="form-control" id="client_nom" name="client_nom" value="{{ old('client_nom') }}">
                    </div>
...
<script>
    ...
    // Assure le calcul initial si des valeurs sont déjà présentes (ex: après erreur de validation)
